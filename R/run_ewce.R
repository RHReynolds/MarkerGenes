...
#' @param celltypeLevel Choose whether to run only with level 1 cell types or
#'   both. 1 for only level 1, or "both" for both.
...
run_ewce_controlled <- function(list_of_genes, ..., celltypeLevel = c(1, "both"), reps, genelistSpecies = c("human"),sctSpecies = c("mouse", "human")) {
