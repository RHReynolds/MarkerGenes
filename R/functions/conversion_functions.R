...
#'
#' \code{convert_between_species} Allows user to convert between species
#' dependent on species in the query gene vector and the ctd matrices of
#' interest.
#'
...
#' respectively.
#'
#' \code{convert_between_ensembl_and_symbols} Allows user to convert ensembl IDs
#' to symbols for human or mouse.
#'
