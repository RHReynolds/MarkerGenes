...
load("/home/rreynolds/projects/MarkerGenes/specificity_matrices/AIBS2018_MTG.rda")
...
- The majority of specificity matrices were downloaded from Skene 2018, but also generated two matrices from:
    ...
    - Allen Brain Atlas 2019 (see: `/home/rreynolds/projects/MarkerGenes/misc_scripts/20190501_AIBS2018_GeneratingSImatrix.R`). Used gene-level (exonic) read count values. While intronic values were available, reckoned that these would tag pre-mRNA.
...
Wang_results_UMI <- run_ewce_controlled(list_of_genes, reps = 10000, celltypeLevel = 2,
                               genelistSpecies = "human", sctSpecies = "human",
                               ctd_AIBS2018)
write_csv(Wang_results_UMI, path = "/home/rreynolds/projects/MarkerGenes/results/20190523_EWCE_Wang2018_UMI_AIBS2018_10000bootstrap.csv")
...
Wang_results_UMI <- read_csv(file = "/home/rreynolds/projects/MarkerGenes/results/20190523_EWCE_Wang2018_UMI_AIBS2018_10000bootstrap.csv") %>% 
  dplyr::mutate(FDR = p.adjust(p, method = "BH"))
