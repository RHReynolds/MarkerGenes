...
- For metadata on the available lists/matrices, please refer to: [dataset_metadata.html](docs/dataset_metadata.html).

Resouce also contains a number of functions that:
    - Allow users to query specificity matrices ([`query_gene_ctd()`](https://github.com/RHReynolds/MarkerGenes/blob/master/R/query_gene_ctd.R) - for more details, see [query_gene_ctd_tutorial.Rmd](docs/query_gene_ctd_tutorial.html)) 
